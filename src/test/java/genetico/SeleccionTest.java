...
public class SeleccionTest {
    ...
    private AlgoritmoSeleccion selector = new SeleccionAleatoria();
    ...
    private Generacion generacionA() {
        Individuo individuo1 = Util.createIndividual(41, 45, 4, 9, 38, 21, 60, 59, 63, 27, 12, 67, 82, 58, 78, 3, 2, 11,
                55, 34, 81, 64, 1, 37, 80, 15, 49, 30, 47, 18, 35, 24, 23, 51, 39, 0, 33, 8, 44, 70, 68, 7,
                19, 6, 50, 43, 42, 71, 14, 66, 79, 29, 75, 72, 73, 76, 74, 56, 62, 5, 65, 54, 52, 53, 69, 28,
                46, 20, 10, 32, 48, 36, 17, 16, 57, 26, 25, 13, 61, 77, 31, 22, 40);
    ...
    public void parejasAleatorias(int resultado, Generacion generacion) {
        List<Individuo[]> res = selector.aplicar(generacion);

        System.out.println("PAREJAS ALEATORIAS - ALGORITMO DE SELECCION - TEST 1 - RESULTADOS:");
    ...
    @Test
    public void test1() {
        parejasAleatorias(2,generacionA());
        parejasAleatorias(3,generacionB());
    }
    ...
    public void parejasAleatorias2() {
        int resultado1 = 3;
        List<Individuo[]> res = selector.aplicar(generacionB());
        ...
        assertEquals(resultado1, res.size());
    }
}
